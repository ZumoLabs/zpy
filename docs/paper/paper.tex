...
\begin{figure}
	...
	\caption{(Left) Sample images from synthetic training datasets with different kinds of domain randomization: lighting, background, material, and all of the above. (Right) Bounding box predictions of a model fine-tuned on the corresponding synthetic dataset along with confidence for each detection, false positives shown for context.}
	\label{fig:results}
\end{figure}
