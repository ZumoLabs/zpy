...
Blender allows for user-created AddOns, and provides tooling for integrating addon functionality with the Blender UI.

Popular AddOns include X, X, and X.

Those who use Blender in their 3D workflow are
