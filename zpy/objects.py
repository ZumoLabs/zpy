...
def load_blend_obj(
    name: str, path: Union[Path, str], link: bool = False,
) -> bpy.types.Object:
...
def empty_collection(
    collection: bpy.types.Collection = None, method: str = "data",
) -> None:
...
def is_inside(
    location: Union[Tuple[float], mathutils.Vector], obj: Union[bpy.types.Object, str],
) -> bool:
...
def toggle_hidden(
    obj: Union[bpy.types.Object, str], hidden: bool = True, filter_string: str = None,
) -> None:
...
def randomly_hide_within_collection(
    collections: List[bpy.types.Collection], chance_to_hide: float = 0.9,
) -> None:
...
def jitter_mesh(
    obj: Union[bpy.types.Object, str], scale: Tuple[float] = (0.01, 0.01, 0.01),
) -> None:
