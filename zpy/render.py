...
def make_aov_file_output_node(
    style: str = "rgb", add_hsv: bool = True, add_lens_dirt: bool = False,
...
def hsv_node(
    node_tree: bpy.types.NodeTree, input_node: bpy.types.Node,
) -> bpy.types.Node:
...
def _render(
    threads: int = 4, logfile_path: Union[Path, str] = "blender_render.log",
) -> None:
