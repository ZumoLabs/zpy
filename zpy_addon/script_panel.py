...
class SCENE_PT_ScriptPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = layout.row()
        row.operator(
            "scene.zpy_load_templates", text="Load Templates", icon="TEXT",
        )
        row = layout.row()
        ...
        row = layout.row()
        row.operator(
            "scene.zpy_load_runpy", text="Pull", icon="IMPORT",
        )
        row.operator(
            "scene.zpy_push_runpy", text="Push", icon="EXPORT",
        )
        row = layout.row()
        ...
        row = layout.row()
        row.operator(
            "scene.zpy_load_gin_config", text="Pull", icon="IMPORT",
        )
        row.operator(
            "scene.zpy_push_gin_config", text="Push", icon="EXPORT",
        )
...
def script_template_menu(self, context):
    ...
    self.layout.operator("text.zpy_load_ginconfig_template", text="(zpy) Config Text")
